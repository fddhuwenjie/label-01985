...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'score-trend', name: 'ScoreTrend', component: () => import('@/views/ScoreTrend.vue'), meta: { title: '成绩趋势' } },
      { path: 'score-alert', name: 'ScoreAlert', component: () => import('@/views/ScoreAlert.vue'), meta: { title: '成绩预警' } },
      { path: 'class-compare', name: 'ClassCompare', component: () => import('@/views/ClassCompare.vue'), meta: { title: '班级对比' } }
    ]
  }
]
