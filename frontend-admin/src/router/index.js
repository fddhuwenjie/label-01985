...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'trend', name: 'Trend', component: () => import('@/views/ScoreTrend.vue'), meta: { title: '成绩趋势' } },
      { path: 'alert', name: 'Alert', component: () => import('@/views/ScoreAlert.vue'), meta: { title: '成绩预警' } },
      { path: 'class-compare', name: 'ClassCompare', component: () => import('@/views/ClassComparison.vue'), meta: { title: '班级对比' } }
    ]
  }
]
